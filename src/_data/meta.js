...
export const siteName = 'No Script Show';
...
export const author = {
  name: 'David Waumsley', // i.e. Lene Saile - page / blog author's name. Must be set.
  avatar: '/icon-512x512.png', // path to the author's avatar. In this case just using a favicon.
  email: 'david@davidwaumsley.com', // i.e. hola@lenesaile.com - email of the author
  website: 'https://noscript.show'// i.e. https.://www.lenesaile.com - the personal site of the author  
};
